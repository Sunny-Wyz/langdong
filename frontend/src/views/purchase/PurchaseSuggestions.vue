    ...
    <div style="padding: 24px">
        <el-card>
            ...
            <el-table :data="suggestions" border v-loading="loading" :row-class-name="urgencyRowClass">
                ...
                <el-table-column prop="suggestMonth" label="建议月份" width="100" sortable ></el-table-column>
                <el-table-column prop="currentStock" label="当前库存" width="90" align="center" sortable ></el-table-column>
                <el-table-column prop="reorderPoint" label="ROP补货点" width="100" align="center" sortable ></el-table-column>
                <el-table-column prop="suggestQty" label="建议采购量" width="100" align="center" sortable ></el-table-column>
                <el-table-column prop="forecastQty" label="月预测量" width="95" align="center" sortable ></el-table-column>
                <el-table-column label="置信区间" width="130" align="center" sortable >
                    <template slot-scope="scope">
                        <span>{{ scope.row.lowerBound }} ~ {{ scope.row.upperBound }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="urgency" label="紧急程度" width="95" align="center" sortable >
                    <template slot-scope="scope">
